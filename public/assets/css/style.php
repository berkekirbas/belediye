...
optgroup label {
 ...
 .innerPageNews .overlay {
     background: #870000d6 none repeat scroll 0 0;
     height: 100%;
     left: 0;
     position: absolute;
     text-align: center;
 ...
 .arama_alan{
     background: -moz-linear-gradient(270deg,#870000, #fff);
    /* FF3.6+ */
     background: -webkit-linear-gradient(270deg,#870000,#fff);
    /* Chrome10+,Safari5.1+ */
     background: -o-linear-gradient(270deg,#870000,#fff);
    /* Opera11.10+ */
     background: -ms-linear-gradient(270deg,#870000,#fff);
    /* IE10+ */
     filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#870000', endColorstr='#fff',GradientType=0 );
    /* IE6-9 */
     background: linear-gradient(270deg,#870000,#fff);
    /* W3C */
     padding: 5px;
     margin-top:-5px;
     margin-bottom: 25px;
