    ...
    <div class="col-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-0">Albüm Düzenle</h3>
            </div>
            <form class="card-body" action="{{ route('photo.update', $gallery->id) }}" method="POST"
                ...
                <div class="form-group mb-3">
                    <label class="form-label">Mevcut Albüm Fotoğrafları</label>
