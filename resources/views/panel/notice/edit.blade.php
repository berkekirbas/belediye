    ...
    <div class="col-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title mb-0">Duyuru Düzenle</h3>
            </div>
            <form class="card-body" action="{{ route('notice.update', $notice->id) }}" method="POST"
                     ...
                     @if ($notice->image)
                        <div class="mb-2">
                            <img src="{{ $notice->image_url }}"
                                style="width:120px;height:auto;border-radius:4px; cursor:pointer;" alt="Duyuru Görseli"
                                id="currentImage">
                        </div>
                    @endif
