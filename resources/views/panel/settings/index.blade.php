            ...
            <form class="card-body" action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{ $settings->title ?? old('title') }}">
                        <span class="text-danger">{{ $errors->first('title') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <label class="form-label">Site URL</label>
                        <input name="url" id="url" class="form-control" value="{{ $settings->url ?? old('url') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="file" class="form-control" name="footer_logo"  accept="image/jpeg,image/png,image/webp,image/gif">
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="file" class="form-control" name="favicon"  accept="image/jpeg,image/png,image/webp,image/ico/image/x-icon">
                    ...
                    <div class="form-group mb-3 col-md-3">
                        ...
                        <input type="file" class="form-control" name="orta_banner"  accept="image/jpeg,image/png,image/webp,image/gif">
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="file" class="form-control" name="baskan_photo"  accept="image/jpeg,image/png,image/webp,image/gif">
                    ...
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" name="baskan_fullname" value="{{ $settings->baskan_fullname ?? old('baskan_fullname') }}">
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <input type="text" class="form-control" name="phone" value="{{ $settings->phone ?? old('phone') }}">
                        <span class="text-danger">{{ $errors->first('phone') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-4">
                        <label class="form-label">Fax</label>
                        <input type="text" class="form-control" name="fax" value="{{ $settings->fax ?? old('fax') }}">
                        <span class="text-danger">{{ $errors->first('fax') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-4">
                        <label class="form-label">E-mail</label>
                        <input type="text" class="form-control" name="email" value="{{ $settings->email ?? old('email') }}">
                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-6">
                        ...
                        <input type="text" class="form-control" name="facebook_url" value="{{ $settings->facebook_url ?? old('facebook_url') }}">
                        <span class="text-danger">{{ $errors->first('facebook_url') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <label class="form-label">YouTube URL</label>
                        <input type="text" class="form-control" name="youtube_url" value="{{ $settings->youtube_url ?? old('youtube_url') }}">
                        <span class="text-danger">{{ $errors->first('youtube_url') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <label class="form-label">Twitter URL</label>
                        <input type="text" class="form-control" name="twitter_url" value="{{ $settings->twitter_url ?? old('twitter_url') }}">
                        <span class="text-danger">{{ $errors->first('twitter_url') }}</span>
                    </div>
                    <div class="form-group mb-3 col-md-6">
                        <label class="form-label">Linkedin URL</label>
                        <input type="text" class="form-control" name="linkedin_url" value="{{ $settings->linkedin_url ?? old('linkedin_url') }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="checkbox" class="form-check-input" name="suggestion_status" value="1" {{ $settings->suggestion_status ? 'checked' : '' }}>
                    <span class="text-danger">{{ $errors->first('suggestion_status') }}</span>
                </div>
                <div class="form-group mb-3">
                    <label class="form-label">Site Durumu</label>
                    <input type="checkbox" class="form-check-input" name="site_status" value="1" {{ $settings->site_status ? 'checked' : '' }}>
